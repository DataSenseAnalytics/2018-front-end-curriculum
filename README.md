...
| JavaScript debugging<br / -[Advanced JS Debugging](https://keyholesoftware.com/2014/01/06/advanced-debugging-techniques-in-javascript-part-1/)<br />- nodeJS debugging <br />- [Debug It Book](https://www.e-reading.club/bookreader.php/142038/Debug_It%21_Find%2C_Repair%2C_and_Prevent_Bugs_in_Your_Code.pdf)<br />- Chrome dev tools (source, network, console panel) ([basics](https://developers.google.com/web/tools/chrome-devtools/javascript/), and [kitchen sink](http://devtoolstips.com/)) |
...
| Debugging (with Chrome developer tools)<br />- elements, networks panels |
...
| HTML Templating <br />-  Using library<br />- ES2015 template literal |
